  ...
  Widget build(BuildContext context) {
    final ButtonStyle mySegmentedButtonStyle = ButtonStyle(
      ...
      textStyle: WidgetStatePropertyAll(
        TextTheme.of(context).bodyMedium!.copyWith(fontSize: 16),
      ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Center(
                                  child: Text('Lastna Organizacija'),
                                ),
                              ),
                            ],
                          ),
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Center(
                                      child: Text(
                                        '${calculateStudioDvoranaPrice(tecajniki)} €',
                                      ),
                                    ),
                                  ),
                                  Expanded(
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Center(
                                          child: Text(
                                            '${calculateStudioFootage(tecajniki)} €',
                                          ),
                                        ),
                                      ),
                                      Expanded(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Center(child: Text('1€/tečajnika')),
                          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _selectedViewMode.first == ViewMode.table
                            ? Center(
                              child: Text(
                                'Izberi prikaz primera za izračun',
                              ),
                            )
                            : Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              children: [
                                Text(
                                  'Celoten priliv: $tecajniki x $classPrice € = ${tecajniki * classPrice} €',
                                ),
