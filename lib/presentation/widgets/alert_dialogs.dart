  ...
  return showDialog(
    ...
    builder:
        (context) => AlertDialog.adaptive(
          title: Text(title, style: TextStyle(fontSize: 36)),
          backgroundColor: Colors.white,
          content: content != null ? Text(content, style: TextStyle(fontSize: 24, color: Colors.black54)) : null,
              ...
              kIsWeb || !Platform.isIOS
                  ? <Widget>[
                    ...
                    TextButton(
                      ...
                      child: Text(defaultActionText, style: TextStyle(fontSize: 24)),
...
}) => showAlertDialog(context: context, title: title, content: exception.toString(), defaultActionText: 'OK');
